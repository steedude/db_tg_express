...
const reserveWizard = new WizardScene(
  ...
  async ctx =>  {
    ...
    const date = moment(`2023-${datas.month.slice(0, 2)}-${datas.date.slice(0, 2)}, ${datas.hour}:${datas.mins}`, "YYYY-MM-DD, hh:mm").format('YYYY-MM-DD, hh:mm');
